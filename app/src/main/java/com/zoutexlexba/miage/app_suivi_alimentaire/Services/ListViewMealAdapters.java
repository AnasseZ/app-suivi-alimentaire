...
public class ListViewMealAdapters extends BaseAdapter {

    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    TextView txtFirst;
    TextView txtSecond;
    public ListViewMealAdapters(Activity activity, ArrayList<HashMap<String, String>> list){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtFirst.setText(map.get(FIRST_COLUMN_MEAL));
        txtSecond.setText(map.get(SECOND_COLUMN_MEAL));
