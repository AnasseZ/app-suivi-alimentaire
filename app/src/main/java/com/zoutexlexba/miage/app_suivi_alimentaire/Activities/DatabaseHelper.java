...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /**Quentin tu peux utiliser cette méthode pour la création d'un utilisateur
     * @param user
     */
   ...
   public List<User> getAllUser() {
        // les noms d'attribut de la table
        String[] columns = {
                COLUMN_USER_ID,
                COLUMN_USER_EMAIL,
                COLUMN_USER_NAME,
        ...
        // scette méthode permet juste d'ordonner le résultat
        ...
        // Parcours du résultat de cursor et ajout dans la liste
